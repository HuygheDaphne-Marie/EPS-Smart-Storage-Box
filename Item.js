  ...
  order(amount) {
    if(this.stock - amount >= 0) {
      ...
      try {
        ...
        throw 'WEE WOO: Stock must be changed by a whole positive number!'; // Tell user he tried to change stock by the wrong type of number
      }
    } else {
      throw 'WEE WOO: Not enough stock!'; // Not enough items left to fullfill order
    }
  }
